export default {
  ...
  table: {
    ...
    selectRows: 'The {row} item is selected',
    clear: 'clear',
    reset: 'reset',

    inputPlz: 'please input {name}',
    selectPlz: 'please select {name}',

    advancedSearch: 'advanced Search',
    query: 'query'
  },
  upload: {
    uploadPlz: 'Please select {name} file to upload!',

    uploadWarn: 'The uploaded file cannot exceed 150MB!'
  }
}
